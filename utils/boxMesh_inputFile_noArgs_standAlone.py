...
in_fp = open_file(inputFileName)
Length = read_float_from_file_pointer(in_fp, "Length")
Height = read_float_from_file_pointer(in_fp, "Height")
Width = read_float_from_file_pointer(in_fp, "Width")
highResWidth = read_float_from_file_pointer(in_fp, "highResWidth")
meshScale = read_float_from_file_pointer(in_fp, "meshScale")
in_fp.close()
